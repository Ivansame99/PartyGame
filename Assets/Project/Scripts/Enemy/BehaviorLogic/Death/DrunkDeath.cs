...
[CreateAssetMenu(fileName = "EnemyDeath", menuName = "Enemy Logic/Drunk/Status Logic/Enemy Death")]
public class DrunkDeath : EnemyDeathSOBase
{
	...
	private string diePath = "event:/SFX/Enemies/Drunk/Die";
    ...
    {
        base.DoEnterLogic();
        enemy.drunkAudioManager.PlayDeath();
